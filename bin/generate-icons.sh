...
iosLogo="$root/res/icon-1024-white.png"
...
convert "$iosLogo" -resize 20x20      "$iosPath/icon-20.png"
convert "$iosLogo" -resize 48x48      "$iosPath/icon-24@2x.png"
convert "$iosLogo" -resize 55x55      "$iosPath/icon-27.5@2x.png"
convert "$iosLogo" -resize 87x87      "$iosPath/icon-29@3x.png"
convert "$iosLogo" -resize 88x88      "$iosPath/icon-44@2x.png"
convert "$iosLogo" -resize 172x172    "$iosPath/icon-86@2x.png"
convert "$iosLogo" -resize 196x196    "$iosPath/icon-98@2x.png"
convert "$iosLogo" -resize 1024x1024  "$iosPath/icon-1024.png"
convert "$iosLogo" -resize 108x108    "$iosPath/icon-108@2x.png"